...
//[assembly: DefaultDependency(typeof(SportNow.iOS.CameraIOS))]
//[assembly: ExportRenderer(typeof(CameraIOS), typeof(CameraInterface))]
[assembly: Dependency(typeof(SportNow.iOS.CameraIOS))]
    ...
    public class CameraIOS : CameraInterface
    {
        ...
        private void GotAccessToCamera(FileFormatEnum imageType, string imageId = null)
        {
            ...
            imagePicker.FinishedPickingMedia += (sender, e) =>
            {
                ...
                Debug.Print("GotAccessToCamera IOS rotateImage.Size.Width = " + rotateImage.Size.Width);
                Debug.Print("GotAccessToCamera IOS rotateImage.Size.Height = " + rotateImage.Size.Height);
